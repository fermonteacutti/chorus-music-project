      ...
      <div className="max-w-4xl mx-auto px-4 md:px-8">
        ...
        <header className="mb-12">
          ...
          <div className="flex flex-wrap items-center gap-6 text-sm text-muted-foreground font-sans">
            <div className="flex items-center gap-2"><User className="h-4 w-4" /><span>{post.author_name}</span></div>
        ...
        <div className="border-t pt-8">
          <div className="flex items-center gap-4">
            ...
            <div>
              <p className="font-semibold text-lg font-sans">{post.author_name}</p>
