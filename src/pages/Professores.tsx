...
const allTeachers = [
  ...
  { id: 5, name: "Prof. Fernando Lima", instrument: "Saxofone e Flauta", bio: "Músico profissional com formação em instrumentos de sopro pela Berklee College of Music. Experiência em orquestras e bandas de jazz.", initials: "FL", specialties: ["Jazz", "Música Clássica", "Improvisação"] },
  { id: 6, name: "Profa. Mariana Rocha", instrument: "Musicalização Infantil", bio: "Pedagoga musical especializada em educação infantil. Desenvolveu metodologia lúdica para crianças a partir de 8 meses de idade.", initials: "MR", specialties: ["Educação Infantil", "Método Orff", "Ludopedagogia"] }
];
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {allTeachers.map((teacher, index) => (
            <Card key={teacher.id} className="p-8">
              ...
              <p className="text-muted-foreground text-sm leading-relaxed mb-6 font-sans">{teacher.bio}</p>
